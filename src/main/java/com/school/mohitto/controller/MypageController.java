...
public class MypageController {
    ...
    public HairResponseList getSavedHairs(
        ...
        HairResponseList response = hairService.getSavedHairs(authUserInfo.userId(), pageable);
        return response;
    }
    ...
    public DeletedHairResponse deleteSavedHair(
            @AuthUser AuthUserInfo authUserInfo,
        ...
        DeletedHairResponse response = new DeletedHairResponse(hairId);
        return response;
    }
